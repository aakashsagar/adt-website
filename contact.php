        ...
        <div class="form-card">
          ...
          <form onsubmit="handleSubmit(event)">
            <div class="form-row">
              ...
              <div class="fg"><label>Last Name *</label><input type="text" placeholder="Sharma" required></div>
            </div>
            <div class="fg"><label>Email Address *</label><input type="email" placeholder="rahul@company.com" required></div>
            <div class="fg"><label>Phone Number</label><input type="tel" placeholder="+91 98765 43210"></div>
            <div class="fg"><label>Company / Organisation</label><input type="text" placeholder="Your company name"></div>
            <div class="fg">
            ...
            <div class="fg"><label>Your Message *</label><textarea placeholder="Tell us about your project, requirements, or any questions you have..." required></textarea></div>
...
function handleSubmit(e){
  ...
  setTimeout(()=>{
    btn.innerHTML='<span>Send Message</span><svg viewBox="0 0 24 24" width="18" fill="white"><path d="M22 2L11 13M22 2L15 22l-4-9-9-4 20-7z"/></svg>';
